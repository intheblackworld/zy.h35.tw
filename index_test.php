...
<head>
    ...
    <link rel="stylesheet" href="css/style_x.css?v1">
    <!-- house info -->
    <link href="css/template/contact-section_x.css?v1" rel="stylesheet" />
    <link href="css/template/form.css?v1" rel="stylsheet" />
...
<body class="stop-scroll">
    <div id="app">
        ...
        <header class="header">
            <div class="header_logo">
                <img src="img/logo.png" alt="正義聯盟 | 七大逆天神力，給你成家超能力" @click="setPageTransform('kv1')">
            </div>
            <div class="header_inner">
                <ul class="menu">
                    <li class="menu_item" v-for="(item, index) in menu">
                        <a class="menu_link" @click="setPageTransform(item.anchor)">
                ...
                <ul class="social">
                    <li class="social_item">
                        <a class="social_link social-fb" @click="setPageTransform('p9')">
                            <img src="img/icon-fb.png" alt="正義聯盟facebook">
                        </a>
                    </li>
                    <li class="social_item">
                        <a class="social_link social-msg" @click="setPageTransform('p9')">
                            <img src="img/icon-messager.png" alt="正義聯盟messager">
                        </a>
                    </li>
                    <li class="social_item">
                        <a class="social_link social-map" @click="setPageTransform('p9')">
        ...
        <div class="sidemenu" :class="{on: status.sidemenu}">
            <nav class="sidemenu_inner">
                ...
                <ul class="sidemenu_social">
                    <li class="social_item">
                        <a class="social_link social-fb" @click="setPageTransform('p8')">
                            <img src="img/icon-fb.png" alt="正義聯盟facebook">
                        </a>
                    </li>
                    <li class="social_item">
                        <a class="social_link social-msg" @click="setPageTransform('p8')">
                            <img src="img/icon-messager.png" alt="正義聯盟facebook messager">
                        </a>
                    </li>
                    <li class="social_item">
                        <a class="social_link social-map" @click="setPageTransform('p8')">
                            <img src="img/icon-map.png" alt="正義聯盟地圖">
                        </a>
                    </li>
                </ul>
        ...
        <main class="wrapper" :style="pageStyleObject">
            ...
            <div class="section section-livable">
            ...
            <div class="section section-monster">
            ...
            <div class="section section-greensea">
            ...
            <div class="section section-intro">
                <main class="intro">
                    ...
                    <div class="intro_content unscroll text-border-white" :class="{on: status.intro}">
            ...
            <div style="background: #fff">
                <!-- 預約參觀區塊 -->
                <!-- 公版開始 -->
                <section class="sectionMP" id="section-Reservation" style="padding: 0;height: auto;">
                    <div class="order-bg">
                        <h3 class="order-title" v-if="!isMobile">預約賞屋</h3>
                        <h3 class="order-subtitle" v-if="!isMobile"></h3>
                        <div class="order section section-template unscroll" v-if="!isMobile">
                            <div>
                        ...
                        <div class="contact-info section section-contact">
                            ...
                            <div class="info">
                                ...
                                <a class="btn flex-c hidden-xs" href="https://m.me/2066330633489731" target="_blank">
                                    <span class="flex-c">
                                ...
                                <a class="google-btn flex-c hidden-xs" href="https://goo.gl/maps/md3qUjA8GZr4WwGK6" target="_blank">
                                    <span class="flex-c">
                        ...
                        <!-- <div class="google-map">
                            <iframe title="googlemap" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3614.157186633172!2d121.63753931549844!3d25.062660983958917!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x345d534f7fbc7681%3A0xdfbeaaabc3c5388e!2z6LaF57Sa6Iqx5ZyS!5e0!3m2!1szh-TW!2stw!4v1562425650286!5m2!1szh-TW!2stw" width="100%" height="455" frameBorder="0" style="border: 0" allowFullScreen></iframe>
                        </div> -->
                    </div>
                </section>
                <!-- <div class="footer">
        ...
        <footer>
            ...
            <div class="mobile-nav" :class="{on: status.footer}">
                <a class="nav-item" @click="showCallDialog()">
                    <i class="fas fa-phone"></i>
                    <div class="label">撥打電話</div>
                </a>

                <a class="nav-item" @click="switchStatus('reservation', true)">
                ...
                <div class="dialog messenger-dialog">
                    <div class="dialog-content">
                        ...
                        <a class="cta" href="https://m.me/2066330633489731" target="_blank">立即諮詢</a>
                    </div>
                </div>
                <div class="dialog map-dialog">
                    <div class="dialog-content">
                        ...
                        <a class="cta" href="https://goo.gl/maps/md3qUjA8GZr4WwGK6" target="_blank">開啟導航</a>
                    </div>
                </div>
            </div>
    ...
    <?php include_once 'incl/script_x.php'; ?>
